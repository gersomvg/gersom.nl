...
I could off course post all my writing to platforms like Medium or LinkedIn, but then I'd give away control over target audience, indexing and free access. Medium, for example, allows for a maximum of three free articles per visitor per month. I believe it's better to host your own content and only use other platforms to link to your articles. There is one other website that I would consider cross posting full articles to, which is [dev.to](https://dev.to). This developer-oriented community allows for a [canonical URL](https://en.wikipedia.org/wiki/Canonical_link_element), that points crawlers like Google to the original copy on my own website.
...
I expect that this website will help me to try out new web development technologies. I don't like to build useless side projects, just to try out some new library. This website provides me with a 'production environment' to try out new technologies.
