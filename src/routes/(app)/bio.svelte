<script lang="ts">
	...
	const socials = [
		['Email', 'email', `mailto:website.${ddmmyyyy}@gersom.nl`],
		['Github', 'github', 'https://github.com/gersomvg'],
		['LinkedIn', 'linkedin', 'https://www.linkedin.com/in/gersom/'],
	] as const
</script>
...
<div class="flex flex-1 flex-col justify-center p-3 md:p-5 lg:py-10">
	...
	>
		Avid long-distance runner from Amsterdam with a love for mountains, currently building out a new business; stay tuned!
	</p>
